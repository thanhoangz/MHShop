namespace MH.Data.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<MH.Data.MHShopDbContext>
    {
        ...
        protected override void Seed(MH.Data.MHShopDbContext context)
        {
        ...
        private void CreateUser(MHShopDbContext context)
        {
            var manager = new UserManager<ApplicationUser>(new UserStore<ApplicationUser>(new MHShopDbContext()));

            var roleManager = new RoleManager<IdentityRole>(new RoleStore<IdentityRole>(new MHShopDbContext()));
        ...
        private void CreateProductCategorySample(MH.Data.MHShopDbContext context)
        {
        ...
        private void CreateFooter(MHShopDbContext context)
        {
        ...
        private void CreateSlide(MHShopDbContext context)
        {
        ...
        private void CreatePage(MHShopDbContext context)
        {
